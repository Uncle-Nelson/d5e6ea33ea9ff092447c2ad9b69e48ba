...
namespace Funly.SkyStudio
{
	...
	{
		// Token: 0x0600089F RID: 2207 RVA: 0x000272F3 File Offset: 0x000254F3
		public SpherePointKeyframeGroup(string name) : base(name)
		{
		}

		// Token: 0x060008A0 RID: 2208 RVA: 0x000272FC File Offset: 0x000254FC
		public SpherePointKeyframeGroup(string name, SpherePointKeyframe keyframe) : base(name)
		{
			base.AddKeyFrame(keyframe);
		}

		// Token: 0x060008A1 RID: 2209 RVA: 0x0002730C File Offset: 0x0002550C
