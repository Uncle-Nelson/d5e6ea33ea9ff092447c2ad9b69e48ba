...
public static class GUIDManager
{
	...
	public static void RegisterObject(IGUIDRegisterable obj)
	{
		...
		{
			Console.LogWarning("RegisterObject called and passed obj whose GUID is already registered. Replacing old entries with new", null);
	...
	public static T GetObject<T>(Guid guid)
	{
		...
		if (!(obj is T))
		{
			Console.LogWarning("Object is not of requested type. Returning default(T)", null);
			return default(T);
		}
		return (T)((object)obj);
	}
	...
	{
		Console.Log("GUIDManager cleared!", null);
