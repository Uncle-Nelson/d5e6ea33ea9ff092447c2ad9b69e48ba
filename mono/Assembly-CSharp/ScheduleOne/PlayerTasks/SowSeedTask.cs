...
namespace ScheduleOne.PlayerTasks
{
	...
	public class SowSeedTask : Task
	{
		...
		// (get) Token: 0x06001314 RID: 4884 RVA: 0x000545C9 File Offset: 0x000527C9
		// (set) Token: 0x06001315 RID: 4885 RVA: 0x000545D1 File Offset: 0x000527D1
		public override string TaskName { get; protected set; } = "Sow seed";

		// Token: 0x06001316 RID: 4886 RVA: 0x000545DC File Offset: 0x000527DC
		public SowSeedTask(Pot _pot, SeedDefinition def)
		{
			...
			this.seed = Object.Instantiate<FunctionalSeed>(def.FunctionSeedPrefab, GameObject.Find("_Temp").transform).GetComponent<FunctionalSeed>();
		...
		// Token: 0x06001317 RID: 4887 RVA: 0x000548B8 File Offset: 0x00052AB8
		...
		// Token: 0x06001318 RID: 4888 RVA: 0x00054A68 File Offset: 0x00052C68
		public override void Success()
		{
			this.successfullyPlanted = true;
			PlayerSingleton<PlayerInventory>.Instance.RemoveAmountOfItem(this.definition.ID, 1U);
			NetworkSingleton<TrashManager>.Instance.CreateTrashItem(this.seed.TrashPrefab.ID, Player.Local.Avatar.CenterPoint, Random.rotation, default(Vector3), "", false);
		...
		// Token: 0x06001319 RID: 4889 RVA: 0x00054B38 File Offset: 0x00052D38
		public override void StopTask()
		{
			...
			Object.Destroy(this.seed.gameObject);
		...
		// Token: 0x0600131A RID: 4890 RVA: 0x00054C04 File Offset: 0x00052E04
		private void OnSeedExitVial()
		{
			this.seedExitedVial = true;
		}

		// Token: 0x0600131B RID: 4891 RVA: 0x00054C10 File Offset: 0x00052E10
