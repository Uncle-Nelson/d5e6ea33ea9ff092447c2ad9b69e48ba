...
namespace ScheduleOne.Combat
{
	...
	{
		// Token: 0x06003206 RID: 12806 RVA: 0x000CFAB0 File Offset: 0x000CDCB0
			...
			if (InstanceFinder.IsServer)
			{
				foreach (Collider collider in Physics.OverlapSphere(origin, num))
				{
					...
					if (componentInParent != null && !list.Contains(componentInParent))
					{
						...
						Impact impact = new Impact(hit, hit.point, (hit.point - origin).normalized, impactForce, impactDamage, EImpactType.Explosion, null, Random.Range(0, int.MaxValue));
