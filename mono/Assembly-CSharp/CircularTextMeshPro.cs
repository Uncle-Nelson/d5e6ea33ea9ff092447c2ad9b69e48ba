...
public class CircularTextMeshPro : MonoBehaviour
{
	...
	{
		this.WarpText();
		TMPro_EventManager.TEXT_CHANGED_EVENT.Add(new Action<Object>(this.ReactToTextChanged));
	}

	// Token: 0x06000076 RID: 118 RVA: 0x00004A44 File Offset: 0x00002C44
	private void OnDisable()
	{
		TMPro_EventManager.TEXT_CHANGED_EVENT.Remove(new Action<Object>(this.ReactToTextChanged));
