...
public class UIControllerDEMO : MonoBehaviour
{
	...
	public void SavesPanel_Select(bool v)
	{
		...
		{
			RectTransform rectTransform2 = Object.Instantiate<RectTransform>(this.SavesPrefab, this.SavesPanelList);
			int index = i;
			rectTransform2.GetComponent<Button>().onClick.AddListener(new UnityAction(delegate()
			{
