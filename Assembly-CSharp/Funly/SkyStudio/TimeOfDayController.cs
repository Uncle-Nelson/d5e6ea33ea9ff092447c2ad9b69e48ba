...
namespace Funly.SkyStudio
{
	...
	public class TimeOfDayController : MonoBehaviour
	{
		...
		// (get) Token: 0x06000A03 RID: 2563 RVA: 0x0002BB38 File Offset: 0x00029D38
		// (set) Token: 0x06000A04 RID: 2564 RVA: 0x0002BB3F File Offset: 0x00029D3F
		public static TimeOfDayController instance { get; private set; }

		// Token: 0x17000241 RID: 577
		// (get) Token: 0x06000A05 RID: 2565 RVA: 0x0002BB47 File Offset: 0x00029D47
		// (set) Token: 0x06000A06 RID: 2566 RVA: 0x0002BB4F File Offset: 0x00029D4F
		public SkyProfile skyProfile
		{
			...
			set
			{
				...
				{
					this.m_SkyProfile = Object.Instantiate<SkyProfile>(value);
				}
				else
				{
		...
		// (get) Token: 0x06000A07 RID: 2567 RVA: 0x0002BB8A File Offset: 0x00029D8A
		// (set) Token: 0x06000A08 RID: 2568 RVA: 0x0002BB92 File Offset: 0x00029D92
		...
		// (get) Token: 0x06000A09 RID: 2569 RVA: 0x0002BBA6 File Offset: 0x00029DA6
		...
		// (add) Token: 0x06000A0A RID: 2570 RVA: 0x0002BBB0 File Offset: 0x00029DB0
		// (remove) Token: 0x06000A0B RID: 2571 RVA: 0x0002BBE8 File Offset: 0x00029DE8
		public event TimeOfDayController.TimeOfDayDidChange timeChangedCallback;

		// Token: 0x17000244 RID: 580
		// (get) Token: 0x06000A0C RID: 2572 RVA: 0x0002BC1D File Offset: 0x00029E1D
		...
		// (get) Token: 0x06000A0D RID: 2573 RVA: 0x0002BC2E File Offset: 0x00029E2E
		...
		// Token: 0x06000A0E RID: 2574 RVA: 0x0002BC37 File Offset: 0x00029E37
		private void Awake()
		{
			TimeOfDayController.instance = this;
		}

		// Token: 0x06000A0F RID: 2575 RVA: 0x0002BC3F File Offset: 0x00029E3F
		private void OnEnabled()
		{
			this.skyTime = this.m_SkyTime;
		}

		// Token: 0x06000A10 RID: 2576 RVA: 0x0002BC4D File Offset: 0x00029E4D
		...
		// Token: 0x06000A11 RID: 2577 RVA: 0x0002BC75 File Offset: 0x00029E75
		...
		// Token: 0x06000A12 RID: 2578 RVA: 0x0002BC84 File Offset: 0x00029E84
		private void Update()
		{
			if (!this.skyProfile)
			{
		...
		// Token: 0x06000A13 RID: 2579 RVA: 0x0002BED5 File Offset: 0x0002A0D5
		public void UpdateGlobalIllumination()
		{
			DynamicGI.UpdateEnvironment();
		}

		// Token: 0x06000A14 RID: 2580 RVA: 0x0002BEDC File Offset: 0x0002A0DC
		...
		// Token: 0x06000A15 RID: 2581 RVA: 0x0002BF94 File Offset: 0x0002A194
		...
		// Token: 0x06000A16 RID: 2582 RVA: 0x0002C01C File Offset: 0x0002A21C
		...
		// Token: 0x06000A17 RID: 2583 RVA: 0x0002C09C File Offset: 0x0002A29C
		public bool StartSkyProfileTransition(SkyProfile toProfile, float duration = 1f)
		{
			...
			BlendSkyProfiles blendSkyProfiles = Object.Instantiate<BlendSkyProfiles>(this.skyProfileTransitionPrefab);
		...
		// Token: 0x06000A18 RID: 2584 RVA: 0x0002C158 File Offset: 0x0002A358
		...
		// Token: 0x06000A19 RID: 2585 RVA: 0x0002C17C File Offset: 0x0002A37C
		...
		// Token: 0x06000A1A RID: 2586 RVA: 0x0002C195 File Offset: 0x0002A395
		public bool IsBlendingInProgress()
		{
			return base.GetComponent<BlendSkyProfiles>();
		}

		// Token: 0x06000A1B RID: 2587 RVA: 0x0002C1A8 File Offset: 0x0002A3A8
