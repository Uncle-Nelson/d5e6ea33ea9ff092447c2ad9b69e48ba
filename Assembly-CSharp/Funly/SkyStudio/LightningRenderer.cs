...
namespace Funly.SkyStudio
{
	...
	{
		// Token: 0x06000A81 RID: 2689 RVA: 0x0002E925 File Offset: 0x0002CB25
		private void Start()
		{
		...
		// Token: 0x06000A82 RID: 2690 RVA: 0x0002E94C File Offset: 0x0002CB4C
		protected override Bounds CalculateMeshBounds()
		{
			return new Bounds(Vector3.zero, new Vector3(500f, 500f, 500f));
		}

		// Token: 0x06000A83 RID: 2691 RVA: 0x0002E96C File Offset: 0x0002CB6C
		protected override BaseSpriteItemData CreateSpriteItemData()
		{
			return new BaseSpriteItemData();
		}

		// Token: 0x06000A84 RID: 2692 RVA: 0x0002E973 File Offset: 0x0002CB73
		...
		// Token: 0x06000A85 RID: 2693 RVA: 0x0002E9A8 File Offset: 0x0002CBA8
		...
		// Token: 0x06000A86 RID: 2694 RVA: 0x0002EA33 File Offset: 0x0002CC33
		...
		// Token: 0x06000A87 RID: 2695 RVA: 0x000045B1 File Offset: 0x000027B1
		protected override void PrepareDataArraysForRendering(int instanceId, BaseSpriteItemData data)
		{
		}

		// Token: 0x06000A88 RID: 2696 RVA: 0x0002EA59 File Offset: 0x0002CC59
		...
		// Token: 0x06000A89 RID: 2697 RVA: 0x0002EA70 File Offset: 0x0002CC70
		protected override int GetNextSpawnCount()
		{
			...
			if (Random.value < this.m_LightningProbability)
			{
		...
		// Token: 0x06000A8A RID: 2698 RVA: 0x0002EAC0 File Offset: 0x0002CCC0
		...
		// Token: 0x06000A8B RID: 2699 RVA: 0x0002EB1C File Offset: 0x0002CD1C
		...
		// Token: 0x06000A8C RID: 2700 RVA: 0x0002EC70 File Offset: 0x0002CE70
		private LightningSpawnArea GetRandomLightningSpawnArea()
		{
			...
			int index = Mathf.RoundToInt((float)Random.Range(0, LightningRenderer.m_SpawnAreas.Count)) % LightningRenderer.m_SpawnAreas.Count;
			return LightningRenderer.m_SpawnAreas[index];
		}

		// Token: 0x06000A8D RID: 2701 RVA: 0x0002ECB8 File Offset: 0x0002CEB8
		...
		// Token: 0x06000A8E RID: 2702 RVA: 0x0002ED0F File Offset: 0x0002CF0F
		...
		// Token: 0x06000A8F RID: 2703 RVA: 0x0002ED29 File Offset: 0x0002CF29
		...
		// Token: 0x06000A90 RID: 2704 RVA: 0x0002ED44 File Offset: 0x0002CF44
		private Vector3 GetRandomWorldPositionInsideSpawnArea(LightningSpawnArea area)
		{
			float x = Random.Range(-area.lightningArea.x, area.lightningArea.x) / 2f;
			float z = Random.Range(-area.lightningArea.z, area.lightningArea.z) / 2f;
			float y = 0f;
		...
		// Token: 0x06000A91 RID: 2705 RVA: 0x0002EDE2 File Offset: 0x0002CFE2
