...
namespace ScheduleOne.PlayerTasks
{
	...
	public class CauldronTask : Task
	{
		...
		// (get) Token: 0x060012C6 RID: 4806 RVA: 0x000524CF File Offset: 0x000506CF
		// (set) Token: 0x060012C7 RID: 4807 RVA: 0x000524D7 File Offset: 0x000506D7
		public Cauldron Cauldron { get; private set; }

		// Token: 0x1700037F RID: 895
		// (get) Token: 0x060012C8 RID: 4808 RVA: 0x000524E0 File Offset: 0x000506E0
		// (set) Token: 0x060012C9 RID: 4809 RVA: 0x000524E8 File Offset: 0x000506E8
		public CauldronTask.EStep CurrentStep { get; private set; }

		// Token: 0x060012CA RID: 4810 RVA: 0x000524F1 File Offset: 0x000506F1
		...
		// Token: 0x060012CB RID: 4811 RVA: 0x00052510 File Offset: 0x00050710
		public CauldronTask(Cauldron caudron)
		{
			...
			this.Gasoline = Object.Instantiate<StationItem>(this.Cauldron.GasolinePrefab, caudron.ItemContainer);
			...
			{
				this.CocaLeaves[i] = Object.Instantiate<StationItem>(this.Cauldron.CocaLeafPrefab, caudron.ItemContainer);
		...
		// Token: 0x060012CC RID: 4812 RVA: 0x00052740 File Offset: 0x00050940
		...
		// Token: 0x060012CD RID: 4813 RVA: 0x00052794 File Offset: 0x00050994
		public override void StopTask()
		{
			...
			{
				Object.Destroy(stationItem.GetModule<IngredientModule>().Pieces[0].gameObject);
				stationItem.Destroy();
			}
		...
		// Token: 0x060012CE RID: 4814 RVA: 0x00052862 File Offset: 0x00050A62
		...
		// Token: 0x060012CF RID: 4815 RVA: 0x00052876 File Offset: 0x00050A76
		...
		// Token: 0x060012D0 RID: 4816 RVA: 0x00052888 File Offset: 0x00050A88
		...
		// Token: 0x060012D1 RID: 4817 RVA: 0x000528E8 File Offset: 0x00050AE8
		...
		// Token: 0x060012D2 RID: 4818 RVA: 0x000529CE File Offset: 0x00050BCE
		private void UpdateInstruction()
		{
			base.CurrentInstruction = CauldronTask.GetStepDescription(this.CurrentStep);
		}

		// Token: 0x060012D3 RID: 4819 RVA: 0x000529E1 File Offset: 0x00050BE1
