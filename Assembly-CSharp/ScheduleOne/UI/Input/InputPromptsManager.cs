...
namespace ScheduleOne.UI.Input
{
	...
	{
		// Token: 0x06004C1A RID: 19482 RVA: 0x0013FB48 File Offset: 0x0013DD48
		public PromptImage GetPromptImage(string controlPath, RectTransform parent)
		{
			...
			if (this.IsControlPathMouseRelated(controlPath))
			{
				...
				{
					return Object.Instantiate<GameObject>(this.LeftClickPromptPrefab, parent).GetComponent<PromptImage>();
				}
				if (controlPath == "middleButton")
				{
					return Object.Instantiate<GameObject>(this.MiddleClickPromptPrefab, parent).GetComponent<PromptImage>();
				}
				if (controlPath == "rightButton")
				{
					return Object.Instantiate<GameObject>(this.RightClickPromptPrefab, parent).GetComponent<PromptImage>();
				}
				return null;
			}
			else
			{
				...
				{
					PromptImageWithText component = Object.Instantiate<GameObject>(this.ExtraWideKeyPromptPrefab, parent).GetComponent<PromptImageWithText>();
					component.Label.text = this.GetDisplayNameForControlPath(controlPath);
					return component;
				}
				if (this.IsControlPathWideKey(controlPath))
				{
					PromptImageWithText component2 = Object.Instantiate<GameObject>(this.WideKeyPromptPrefab, parent).GetComponent<PromptImageWithText>();
					component2.Label.text = this.GetDisplayNameForControlPath(controlPath);
					return component2;
				}
				PromptImageWithText component3 = Object.Instantiate<GameObject>(this.KeyPromptPrefab, parent).GetComponent<PromptImageWithText>();
				component3.Label.text = this.GetDisplayNameForControlPath(controlPath);
				return component3;
			}
		}

		// Token: 0x06004C1B RID: 19483 RVA: 0x0013FC65 File Offset: 0x0013DE65
		...
		// Token: 0x06004C1C RID: 19484 RVA: 0x0013FC98 File Offset: 0x0013DE98
		...
		// Token: 0x06004C1D RID: 19485 RVA: 0x0013FD69 File Offset: 0x0013DF69
		private bool IsControlPathExtraWideKey(string controlPath)
		{
			return controlPath == "space";
		}

		// Token: 0x06004C1E RID: 19486 RVA: 0x0013FD7C File Offset: 0x0013DF7C
